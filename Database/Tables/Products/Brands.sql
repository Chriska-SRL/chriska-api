...
(
    ...
    CONSTRAINT FK_Brands_CreatedBy FOREIGN KEY (CreatedBy) REFERENCES Users(Id),
    CONSTRAINT FK_Brands_UpdatedBy FOREIGN KEY (UpdatedBy) REFERENCES Users(Id),
    CONSTRAINT FK_Brands_DeletedBy FOREIGN KEY (DeletedBy) REFERENCES Users(Id)
);
