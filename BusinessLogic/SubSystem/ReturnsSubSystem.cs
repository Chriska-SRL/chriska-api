...
using BusinessLogic.DTOsCreditNote;
using BusinessLogic.DTOsOrder;
using BusinessLogic.DTOsOrderItem;
using BusinessLogic.DTOsOrderRequest;
...
namespace BusinessLogic.SubSystem
{
    public class ReturnsSubSystem
    {
        ...
        public ReturnsSubSystem(IReturnRequestRepository returnRequestRepository, IUserRepository userRepository, IClientRepository clientRepository, ICreditNoteRepository creditNoteRepository, IOrderRepository orderRepository,)
        {
        ...
        public ReturnRequestResponse GetReturnRequestById(int id)
        {
            ...
            var returnResponse = new ReturnRequestResponse
            {
                ...
                User = userSubSystem.GetUserById(request.User.Id),
                Client = clientsSubSystem.GetClientById(request.Client.Id)
