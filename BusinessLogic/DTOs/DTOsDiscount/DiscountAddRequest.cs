...
namespace BusinessLogic.DTOs.DTOsDiscount
{
    public class DiscountAddRequest : AuditableRequest
    {
        ...
        public required DiscountProductType DiscountProductType { get; set; }
        public List<int>? DiscountProductId { get; set; } = null;
        public required DiscountClientType DiscountClientType { get; set; }
        public List<int>? DiscountClientId { get; set; } = null;
