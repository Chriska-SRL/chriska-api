...
{
    public class VehicleCost:IEntity<VehicleCost.UpdatableData>
    {
        ...
        public VehicleCost(int id, int vehicleId, VehicleCostType type, string description, decimal amount)
        {
            Id = id;
            VehicleId = vehicleId;
            Type = type;
