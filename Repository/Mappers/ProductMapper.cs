    ...
    public static class ProductMapper
    {
        ...
        public static Product? FromReader(SqlDataReader r, string? prefix = null, string? origin = null)
        {
            ...
            return new Product(
                ...
                stock: r.IsDBNull(r.GetOrdinal(Col("Stock"))) ? 0 : r.GetDecimal(r.GetOrdinal(Col("Stock"))),
                availableStocks: r.IsDBNull(r.GetOrdinal(Col("AvailableStock"))) ? 0 : r.GetDecimal(r.GetOrdinal(Col("AvailableStock"))),
